...
public class SubjectsSearchListAdapter extends ArrayAdapter<Subject> {
    ...
    public SubjectsSearchListAdapter(@NonNull Context context, @LayoutRes int resource, ArrayList<Subject> subjects) {
